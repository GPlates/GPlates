...
# 1.36.0, 1.36.1, 1.37, 1.37.0, 1.37.1, 1.38, 1.38.0, 1.38.1,
# 1.39, 1.390, 1.39.1, 1.40, 1.40.0, 1.40.1
#
...
#                                1.37 1.37.0, 1.37.1, 1.38, 1.38.0, 1.38.1
#                                1.39 1.39.0, 1.39.1, 1.40, 1.40.0, 1.40.1
...
if (Boost_FIND_VERSION_EXACT)
  ...
  set( _boost_TEST_VERSIONS ${Boost_ADDITIONAL_VERSIONS} 
    "1.40.1" "1.40.0" "1.40" "1.39.1" "1.39.0" "1.39" 
    "1.38.1" "1.38.0" "1.38" "1.37.1" "1.37.0" "1.37" 
    ...
    ELSE (NOT CMAKE_COMPILER_IS_GNUCC)
      ...
      IF(APPLE)
        IF(Boost_MINOR_VERSION)
          ...
          IF("${Boost_MINOR_VERSION}" STRGREATER "35")
            # In Boost 1.36.0 and newer, the mangled compiler name used
            # on Mac OS X/Darwin is "xgcc".
            SET(_boost_COMPILER "-xgcc${_boost_COMPILER_VERSION}")
          # ELSE(${Boost_MINOR_VERSION} GREATER 35)
          ELSE("${Boost_MINOR_VERSION}" STRGREATER "35")
            # In Boost <= 1.35.0, there is no mangled compiler name for
            # the Mac OS X/Darwin version of GCC.
            SET(_boost_COMPILER "")
          # ENDIF(${Boost_MINOR_VERSION} GREATER 35)
          ENDIF("${Boost_MINOR_VERSION}" STRGREATER "35")
