...
IF (QT4_QMAKE_FOUND)
  ...
  # get include dirs
	...
	ARGS -DBOOST_TT_HAS_OPERATOR_HPP_INCLUDED -DBOOST_NEXT_PRIOR_HPP_INCLUDED -DBOOST_LEXICAL_CAST_INCLUDED -DBOOST_TYPE_TRAITS_HPP -D_SYS_SYSMACROS_H_OUTER -DBOOST_LEXICAL_CAST_DETAIL_CONVERTER_LEXICAL_HPP -DBOOST_VF2_SUB_GRAPH_ISO_HPP ${moc_includes} -o ${outfile} ${infile}
        DEPENDS ${infile}
        VERBATIM)
  ...
  MACRO (QT4_WRAP_CPP outfiles )
    ...
    FOREACH (it ${ARGN})
      ...
      ADD_CUSTOM_COMMAND(OUTPUT ${outfile}
        COMMAND ${QT_MOC_EXECUTABLE}
	ARGS -DBOOST_TT_HAS_OPERATOR_HPP_INCLUDED -DBOOST_NEXT_PRIOR_HPP_INCLUDED -DBOOST_LEXICAL_CAST_INCLUDED -DBOOST_TYPE_TRAITS_HPP -D_SYS_SYSMACROS_H_OUTER -DBOOST_LEXICAL_CAST_DETAIL_CONVERTER_LEXICAL_HPP -DBOOST_VF2_SUB_GRAPH_ISO_HPP ${moc_includes} -o ${outfile} ${it}
        DEPENDS ${it}
        VERBATIM)
  ...
  ENDMACRO (QT4_ADD_RESOURCES)
   ...
   #               SET(_header ${CMAKE_CURRENT_SOURCE_DIR}/${_basename}.h)
                  ...
                  ADD_CUSTOM_COMMAND(OUTPUT ${_moc}
                     COMMAND ${QT_MOC_EXECUTABLE}
                     ARGS -DBOOST_TT_HAS_OPERATOR_HPP_INCLUDED -DBOOST_NEXT_PRIOR_HPP_INCLUDED -DBOOST_LEXICAL_CAST_INCLUDED -DBOOST_TYPE_TRAITS_HPP -D_SYS_SYSMACROS_H_OUTER -DBOOST_LEXICAL_CAST_DETAIL_CONVERTER_LEXICAL_HPP -DBOOST_VF2_SUB_GRAPH_ISO_HPP ${_moc_INCS} ${_header} -o ${_moc}
                     DEPENDS ${_header}
                  )
