...
namespace GPlatesGui
{
	...
	public:
		 ...
		 */
		typedef GPlatesUtils::non_null_intrusive_ptr<ExportFlowlineAnimationStrategy,
		...
		static const QString 
			DEFAULT_FLOWLINES_GMT_FILENAME_TEMPLATE;
		static const QString 
			DEFAULT_FLOWLINES_SHP_FILENAME_TEMPLATE;
		static const QString 
			FLOWLINES_FILENAME_TEMPLATE_DESC;
		static const QString
			FLOWLINES_DESC;
