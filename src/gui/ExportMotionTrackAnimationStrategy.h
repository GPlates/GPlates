...
#ifndef GPLATES_GUI_EXPORTMOTIONTRACKANIMATIONSTRATEGY_H
#define GPLATES_GUI_EXPORTMOTIONTRACKANIMATIONSTRATEGY_H
...
namespace GPlatesGui
{
	 ...
	 * 
	 * ExportMotionTracksAnimationStrategy serves as the concrete Strategy role as
	 * described in Gamma et al. p315. It is used by ExportAnimationContext.
	 */
	class ExportMotionTrackAnimationStrategy:
			public GPlatesGui::ExportAnimationStrategy
	{
	public:
		/**
		 * A convenience typedef for GPlatesUtils::non_null_intrusive_ptr<ExportMotionTracksAnimationStrategy,
		 * GPlatesUtils::NullIntrusivePointerHandler>.
		 */
		typedef GPlatesUtils::non_null_intrusive_ptr<ExportMotionTrackAnimationStrategy,
		...
		static const QString 
			DEFAULT_MOTION_TRACKS_GMT_FILENAME_TEMPLATE;
		static const QString 
			DEFAULT_MOTION_TRACKS_SHP_FILENAME_TEMPLATE;
		static const QString 
			MOTION_TRACKS_FILENAME_TEMPLATE_DESC;
		static const QString
			MOTION_TRACKS_DESC;
		...
		virtual
		~ExportMotionTrackAnimationStrategy()
		{  }
