...
namespace GPlatesGui
{
	namespace BuiltinColourPalettes
	{
		...
		{
			/**
			 * Convert a range of QColor (the form the ColorBrewer tables below are generated in) to Colour.
			 */
			std::vector<Colour>
			to_colours(
					const QColor *begin,
					const QColor *end)
			{
				...
				for ( ; begin != end; ++begin)
				{
					colours.push_back(colour_from_qcolor(*begin));
				}
				return colours;
			}
		...
		namespace ColorBrewer
		{
			/*
				...
				#     sequential_map[std::make_pair(Reds, Three)] = to_colours(coloursReds3, coloursReds3 + 3);
				# 
				# ...and...
				# 
				...
				namespace
				{
							...
							Classes classes)
					{
						...
						if (!sequential_map_initialised)
						{
							...
							sequential_map[std::make_pair(Reds, Four)] = to_colours(coloursReds4, coloursReds4 + 4);
							const QColor coloursReds5[5] = { QColor(254,229,217), QColor(252,174,145), QColor(251,106,74), QColor(222,45,38), QColor(165,15,21) };
							sequential_map[std::make_pair(Reds, Five)] = to_colours(coloursReds5, coloursReds5 + 5);
							...
							sequential_map[std::make_pair(Reds, Six)] = to_colours(coloursReds6, coloursReds6 + 6);
							...
							sequential_map[std::make_pair(Reds, Seven)] = to_colours(coloursReds7, coloursReds7 + 7);
							...
							sequential_map[std::make_pair(Reds, Eight)] = to_colours(coloursReds8, coloursReds8 + 8);
							...
							sequential_map[std::make_pair(Reds, Nine)] = to_colours(coloursReds9, coloursReds9 + 9);

							const QColor coloursYlOrRd3[3] = { QColor(255,237,160), QColor(254,178,76), QColor(240,59,32) };
							sequential_map[std::make_pair(YlOrRd, Three)] = to_colours(coloursYlOrRd3, coloursYlOrRd3 + 3);
							const QColor coloursYlOrRd4[4] = { QColor(255,255,178), QColor(254,204,92), QColor(253,141,60), QColor(227,26,28) };
							sequential_map[std::make_pair(YlOrRd, Four)] = to_colours(coloursYlOrRd4, coloursYlOrRd4 + 4);
							const QColor coloursYlOrRd5[5] = { QColor(255,255,178), QColor(254,204,92), QColor(253,141,60), QColor(240,59,32), QColor(189,0,38) };
							sequential_map[std::make_pair(YlOrRd, Five)] = to_colours(coloursYlOrRd5, coloursYlOrRd5 + 5);
							...
							sequential_map[std::make_pair(YlOrRd, Six)] = to_colours(coloursYlOrRd6, coloursYlOrRd6 + 6);
							...
							sequential_map[std::make_pair(YlOrRd, Seven)] = to_colours(coloursYlOrRd7, coloursYlOrRd7 + 7);
							...
							sequential_map[std::make_pair(YlOrRd, Eight)] = to_colours(coloursYlOrRd8, coloursYlOrRd8 + 8);
							...
							sequential_map[std::make_pair(YlOrRd, Nine)] = to_colours(coloursYlOrRd9, coloursYlOrRd9 + 9);

							const QColor coloursRdPu3[3] = { QColor(253,224,221), QColor(250,159,181), QColor(197,27,138) };
							sequential_map[std::make_pair(RdPu, Three)] = to_colours(coloursRdPu3, coloursRdPu3 + 3);
							const QColor coloursRdPu4[4] = { QColor(254,235,226), QColor(251,180,185), QColor(247,104,161), QColor(174,1,126) };
							sequential_map[std::make_pair(RdPu, Four)] = to_colours(coloursRdPu4, coloursRdPu4 + 4);
							const QColor coloursRdPu5[5] = { QColor(254,235,226), QColor(251,180,185), QColor(247,104,161), QColor(197,27,138), QColor(122,1,119) };
							sequential_map[std::make_pair(RdPu, Five)] = to_colours(coloursRdPu5, coloursRdPu5 + 5);
							...
							sequential_map[std::make_pair(RdPu, Six)] = to_colours(coloursRdPu6, coloursRdPu6 + 6);
							...
							sequential_map[std::make_pair(RdPu, Seven)] = to_colours(coloursRdPu7, coloursRdPu7 + 7);
							...
							sequential_map[std::make_pair(RdPu, Eight)] = to_colours(coloursRdPu8, coloursRdPu8 + 8);
							...
							sequential_map[std::make_pair(RdPu, Nine)] = to_colours(coloursRdPu9, coloursRdPu9 + 9);

							const QColor coloursYlOrBr3[3] = { QColor(255,247,188), QColor(254,196,79), QColor(217,95,14) };
							sequential_map[std::make_pair(YlOrBr, Three)] = to_colours(coloursYlOrBr3, coloursYlOrBr3 + 3);
							const QColor coloursYlOrBr4[4] = { QColor(255,255,212), QColor(254,217,142), QColor(254,153,41), QColor(204,76,2) };
							sequential_map[std::make_pair(YlOrBr, Four)] = to_colours(coloursYlOrBr4, coloursYlOrBr4 + 4);
							const QColor coloursYlOrBr5[5] = { QColor(255,255,212), QColor(254,217,142), QColor(254,153,41), QColor(217,95,14), QColor(153,52,4) };
							sequential_map[std::make_pair(YlOrBr, Five)] = to_colours(coloursYlOrBr5, coloursYlOrBr5 + 5);
							...
							sequential_map[std::make_pair(YlOrBr, Six)] = to_colours(coloursYlOrBr6, coloursYlOrBr6 + 6);
							...
							sequential_map[std::make_pair(YlOrBr, Seven)] = to_colours(coloursYlOrBr7, coloursYlOrBr7 + 7);
							...
							sequential_map[std::make_pair(YlOrBr, Eight)] = to_colours(coloursYlOrBr8, coloursYlOrBr8 + 8);
							...
							sequential_map[std::make_pair(YlOrBr, Nine)] = to_colours(coloursYlOrBr9, coloursYlOrBr9 + 9);

							const QColor coloursGreens3[3] = { QColor(229,245,224), QColor(161,217,155), QColor(49,163,84) };
							sequential_map[std::make_pair(Greens, Three)] = to_colours(coloursGreens3, coloursGreens3 + 3);
							const QColor coloursGreens4[4] = { QColor(237,248,233), QColor(186,228,179), QColor(116,196,118), QColor(35,139,69) };
							sequential_map[std::make_pair(Greens, Four)] = to_colours(coloursGreens4, coloursGreens4 + 4);
							const QColor coloursGreens5[5] = { QColor(237,248,233), QColor(186,228,179), QColor(116,196,118), QColor(49,163,84), QColor(0,109,44) };
							sequential_map[std::make_pair(Greens, Five)] = to_colours(coloursGreens5, coloursGreens5 + 5);
							...
							sequential_map[std::make_pair(Greens, Six)] = to_colours(coloursGreens6, coloursGreens6 + 6);
							...
							sequential_map[std::make_pair(Greens, Seven)] = to_colours(coloursGreens7, coloursGreens7 + 7);
							...
							sequential_map[std::make_pair(Greens, Eight)] = to_colours(coloursGreens8, coloursGreens8 + 8);
							...
							sequential_map[std::make_pair(Greens, Nine)] = to_colours(coloursGreens9, coloursGreens9 + 9);

							const QColor coloursGnBu3[3] = { QColor(224,243,219), QColor(168,221,181), QColor(67,162,202) };
							sequential_map[std::make_pair(GnBu, Three)] = to_colours(coloursGnBu3, coloursGnBu3 + 3);
							const QColor coloursGnBu4[4] = { QColor(240,249,232), QColor(186,228,188), QColor(123,204,196), QColor(43,140,190) };
							sequential_map[std::make_pair(GnBu, Four)] = to_colours(coloursGnBu4, coloursGnBu4 + 4);
							const QColor coloursGnBu5[5] = { QColor(240,249,232), QColor(186,228,188), QColor(123,204,196), QColor(67,162,202), QColor(8,104,172) };
							sequential_map[std::make_pair(GnBu, Five)] = to_colours(coloursGnBu5, coloursGnBu5 + 5);
							...
							sequential_map[std::make_pair(GnBu, Six)] = to_colours(coloursGnBu6, coloursGnBu6 + 6);
							...
							sequential_map[std::make_pair(GnBu, Seven)] = to_colours(coloursGnBu7, coloursGnBu7 + 7);
							...
							sequential_map[std::make_pair(GnBu, Eight)] = to_colours(coloursGnBu8, coloursGnBu8 + 8);
							...
							sequential_map[std::make_pair(GnBu, Nine)] = to_colours(coloursGnBu9, coloursGnBu9 + 9);

							const QColor coloursBuPu3[3] = { QColor(224,236,244), QColor(158,188,218), QColor(136,86,167) };
							sequential_map[std::make_pair(BuPu, Three)] = to_colours(coloursBuPu3, coloursBuPu3 + 3);
							const QColor coloursBuPu4[4] = { QColor(237,248,251), QColor(179,205,227), QColor(140,150,198), QColor(136,65,157) };
							sequential_map[std::make_pair(BuPu, Four)] = to_colours(coloursBuPu4, coloursBuPu4 + 4);
							const QColor coloursBuPu5[5] = { QColor(237,248,251), QColor(179,205,227), QColor(140,150,198), QColor(136,86,167), QColor(129,15,124) };
							sequential_map[std::make_pair(BuPu, Five)] = to_colours(coloursBuPu5, coloursBuPu5 + 5);
							...
							sequential_map[std::make_pair(BuPu, Six)] = to_colours(coloursBuPu6, coloursBuPu6 + 6);
							...
							sequential_map[std::make_pair(BuPu, Seven)] = to_colours(coloursBuPu7, coloursBuPu7 + 7);
							...
							sequential_map[std::make_pair(BuPu, Eight)] = to_colours(coloursBuPu8, coloursBuPu8 + 8);
							...
							sequential_map[std::make_pair(BuPu, Nine)] = to_colours(coloursBuPu9, coloursBuPu9 + 9);

							const QColor coloursOrRd3[3] = { QColor(254,232,200), QColor(253,187,132), QColor(227,74,51) };
							sequential_map[std::make_pair(OrRd, Three)] = to_colours(coloursOrRd3, coloursOrRd3 + 3);
							const QColor coloursOrRd4[4] = { QColor(254,240,217), QColor(253,204,138), QColor(252,141,89), QColor(215,48,31) };
							sequential_map[std::make_pair(OrRd, Four)] = to_colours(coloursOrRd4, coloursOrRd4 + 4);
							const QColor coloursOrRd5[5] = { QColor(254,240,217), QColor(253,204,138), QColor(252,141,89), QColor(227,74,51), QColor(179,0,0) };
							sequential_map[std::make_pair(OrRd, Five)] = to_colours(coloursOrRd5, coloursOrRd5 + 5);
							...
							sequential_map[std::make_pair(OrRd, Six)] = to_colours(coloursOrRd6, coloursOrRd6 + 6);
							...
							sequential_map[std::make_pair(OrRd, Seven)] = to_colours(coloursOrRd7, coloursOrRd7 + 7);
							...
							sequential_map[std::make_pair(OrRd, Eight)] = to_colours(coloursOrRd8, coloursOrRd8 + 8);
							...
							sequential_map[std::make_pair(OrRd, Nine)] = to_colours(coloursOrRd9, coloursOrRd9 + 9);

							const QColor coloursOranges3[3] = { QColor(254,230,206), QColor(253,174,107), QColor(230,85,13) };
							sequential_map[std::make_pair(Oranges, Three)] = to_colours(coloursOranges3, coloursOranges3 + 3);
							const QColor coloursOranges4[4] = { QColor(254,237,222), QColor(253,190,133), QColor(253,141,60), QColor(217,71,1) };
							sequential_map[std::make_pair(Oranges, Four)] = to_colours(coloursOranges4, coloursOranges4 + 4);
							const QColor coloursOranges5[5] = { QColor(254,237,222), QColor(253,190,133), QColor(253,141,60), QColor(230,85,13), QColor(166,54,3) };
							sequential_map[std::make_pair(Oranges, Five)] = to_colours(coloursOranges5, coloursOranges5 + 5);
							...
							sequential_map[std::make_pair(Oranges, Six)] = to_colours(coloursOranges6, coloursOranges6 + 6);
							...
							sequential_map[std::make_pair(Oranges, Seven)] = to_colours(coloursOranges7, coloursOranges7 + 7);
							...
							sequential_map[std::make_pair(Oranges, Eight)] = to_colours(coloursOranges8, coloursOranges8 + 8);
							...
							sequential_map[std::make_pair(Oranges, Nine)] = to_colours(coloursOranges9, coloursOranges9 + 9);

							const QColor coloursYlGnBu3[3] = { QColor(237,248,177), QColor(127,205,187), QColor(44,127,184) };
							sequential_map[std::make_pair(YlGnBu, Three)] = to_colours(coloursYlGnBu3, coloursYlGnBu3 + 3);
							const QColor coloursYlGnBu4[4] = { QColor(255,255,204), QColor(161,218,180), QColor(65,182,196), QColor(34,94,168) };
							sequential_map[std::make_pair(YlGnBu, Four)] = to_colours(coloursYlGnBu4, coloursYlGnBu4 + 4);
							const QColor coloursYlGnBu5[5] = { QColor(255,255,204), QColor(161,218,180), QColor(65,182,196), QColor(44,127,184), QColor(37,52,148) };
							sequential_map[std::make_pair(YlGnBu, Five)] = to_colours(coloursYlGnBu5, coloursYlGnBu5 + 5);
							...
							sequential_map[std::make_pair(YlGnBu, Six)] = to_colours(coloursYlGnBu6, coloursYlGnBu6 + 6);
							...
							sequential_map[std::make_pair(YlGnBu, Seven)] = to_colours(coloursYlGnBu7, coloursYlGnBu7 + 7);
							...
							sequential_map[std::make_pair(YlGnBu, Eight)] = to_colours(coloursYlGnBu8, coloursYlGnBu8 + 8);
							...
							sequential_map[std::make_pair(YlGnBu, Nine)] = to_colours(coloursYlGnBu9, coloursYlGnBu9 + 9);

							const QColor coloursBuGn3[3] = { QColor(229,245,249), QColor(153,216,201), QColor(44,162,95) };
							sequential_map[std::make_pair(BuGn, Three)] = to_colours(coloursBuGn3, coloursBuGn3 + 3);
							const QColor coloursBuGn4[4] = { QColor(237,248,251), QColor(178,226,226), QColor(102,194,164), QColor(35,139,69) };
							sequential_map[std::make_pair(BuGn, Four)] = to_colours(coloursBuGn4, coloursBuGn4 + 4);
							const QColor coloursBuGn5[5] = { QColor(237,248,251), QColor(178,226,226), QColor(102,194,164), QColor(44,162,95), QColor(0,109,44) };
							sequential_map[std::make_pair(BuGn, Five)] = to_colours(coloursBuGn5, coloursBuGn5 + 5);
							...
							sequential_map[std::make_pair(BuGn, Six)] = to_colours(coloursBuGn6, coloursBuGn6 + 6);
							...
							sequential_map[std::make_pair(BuGn, Seven)] = to_colours(coloursBuGn7, coloursBuGn7 + 7);
							...
							sequential_map[std::make_pair(BuGn, Eight)] = to_colours(coloursBuGn8, coloursBuGn8 + 8);
							...
							sequential_map[std::make_pair(BuGn, Nine)] = to_colours(coloursBuGn9, coloursBuGn9 + 9);

							const QColor coloursPuBu3[3] = { QColor(236,231,242), QColor(166,189,219), QColor(43,140,190) };
							sequential_map[std::make_pair(PuBu, Three)] = to_colours(coloursPuBu3, coloursPuBu3 + 3);
							const QColor coloursPuBu4[4] = { QColor(241,238,246), QColor(189,201,225), QColor(116,169,207), QColor(5,112,176) };
							sequential_map[std::make_pair(PuBu, Four)] = to_colours(coloursPuBu4, coloursPuBu4 + 4);
							const QColor coloursPuBu5[5] = { QColor(241,238,246), QColor(189,201,225), QColor(116,169,207), QColor(43,140,190), QColor(4,90,141) };
							sequential_map[std::make_pair(PuBu, Five)] = to_colours(coloursPuBu5, coloursPuBu5 + 5);
							...
							sequential_map[std::make_pair(PuBu, Six)] = to_colours(coloursPuBu6, coloursPuBu6 + 6);
							...
							sequential_map[std::make_pair(PuBu, Seven)] = to_colours(coloursPuBu7, coloursPuBu7 + 7);
							...
							sequential_map[std::make_pair(PuBu, Eight)] = to_colours(coloursPuBu8, coloursPuBu8 + 8);
							...
							sequential_map[std::make_pair(PuBu, Nine)] = to_colours(coloursPuBu9, coloursPuBu9 + 9);

							const QColor coloursPuRd3[3] = { QColor(231,225,239), QColor(201,148,199), QColor(221,28,119) };
							sequential_map[std::make_pair(PuRd, Three)] = to_colours(coloursPuRd3, coloursPuRd3 + 3);
							const QColor coloursPuRd4[4] = { QColor(241,238,246), QColor(215,181,216), QColor(223,101,176), QColor(206,18,86) };
							sequential_map[std::make_pair(PuRd, Four)] = to_colours(coloursPuRd4, coloursPuRd4 + 4);
							const QColor coloursPuRd5[5] = { QColor(241,238,246), QColor(215,181,216), QColor(223,101,176), QColor(221,28,119), QColor(152,0,67) };
							sequential_map[std::make_pair(PuRd, Five)] = to_colours(coloursPuRd5, coloursPuRd5 + 5);
							...
							sequential_map[std::make_pair(PuRd, Six)] = to_colours(coloursPuRd6, coloursPuRd6 + 6);
							...
							sequential_map[std::make_pair(PuRd, Seven)] = to_colours(coloursPuRd7, coloursPuRd7 + 7);
							...
							sequential_map[std::make_pair(PuRd, Eight)] = to_colours(coloursPuRd8, coloursPuRd8 + 8);
							...
							sequential_map[std::make_pair(PuRd, Nine)] = to_colours(coloursPuRd9, coloursPuRd9 + 9);

							const QColor coloursPuBuGn3[3] = { QColor(236,226,240), QColor(166,189,219), QColor(28,144,153) };
							sequential_map[std::make_pair(PuBuGn, Three)] = to_colours(coloursPuBuGn3, coloursPuBuGn3 + 3);
							const QColor coloursPuBuGn4[4] = { QColor(246,239,247), QColor(189,201,225), QColor(103,169,207), QColor(2,129,138) };
							sequential_map[std::make_pair(PuBuGn, Four)] = to_colours(coloursPuBuGn4, coloursPuBuGn4 + 4);
							const QColor coloursPuBuGn5[5] = { QColor(246,239,247), QColor(189,201,225), QColor(103,169,207), QColor(28,144,153), QColor(1,108,89) };
							sequential_map[std::make_pair(PuBuGn, Five)] = to_colours(coloursPuBuGn5, coloursPuBuGn5 + 5);
							...
							sequential_map[std::make_pair(PuBuGn, Six)] = to_colours(coloursPuBuGn6, coloursPuBuGn6 + 6);
							...
							sequential_map[std::make_pair(PuBuGn, Seven)] = to_colours(coloursPuBuGn7, coloursPuBuGn7 + 7);
							...
							sequential_map[std::make_pair(PuBuGn, Eight)] = to_colours(coloursPuBuGn8, coloursPuBuGn8 + 8);
							...
							sequential_map[std::make_pair(PuBuGn, Nine)] = to_colours(coloursPuBuGn9, coloursPuBuGn9 + 9);

							const QColor coloursBlues3[3] = { QColor(222,235,247), QColor(158,202,225), QColor(49,130,189) };
							sequential_map[std::make_pair(Blues, Three)] = to_colours(coloursBlues3, coloursBlues3 + 3);
							const QColor coloursBlues4[4] = { QColor(239,243,255), QColor(189,215,231), QColor(107,174,214), QColor(33,113,181) };
							sequential_map[std::make_pair(Blues, Four)] = to_colours(coloursBlues4, coloursBlues4 + 4);
							const QColor coloursBlues5[5] = { QColor(239,243,255), QColor(189,215,231), QColor(107,174,214), QColor(49,130,189), QColor(8,81,156) };
							sequential_map[std::make_pair(Blues, Five)] = to_colours(coloursBlues5, coloursBlues5 + 5);
							...
							sequential_map[std::make_pair(Blues, Six)] = to_colours(coloursBlues6, coloursBlues6 + 6);
							...
							sequential_map[std::make_pair(Blues, Seven)] = to_colours(coloursBlues7, coloursBlues7 + 7);
							...
							sequential_map[std::make_pair(Blues, Eight)] = to_colours(coloursBlues8, coloursBlues8 + 8);
							...
							sequential_map[std::make_pair(Blues, Nine)] = to_colours(coloursBlues9, coloursBlues9 + 9);

							const QColor coloursGreys3[3] = { QColor(240,240,240), QColor(189,189,189), QColor(99,99,99) };
							sequential_map[std::make_pair(Greys, Three)] = to_colours(coloursGreys3, coloursGreys3 + 3);
							const QColor coloursGreys4[4] = { QColor(247,247,247), QColor(204,204,204), QColor(150,150,150), QColor(82,82,82) };
							sequential_map[std::make_pair(Greys, Four)] = to_colours(coloursGreys4, coloursGreys4 + 4);
							const QColor coloursGreys5[5] = { QColor(247,247,247), QColor(204,204,204), QColor(150,150,150), QColor(99,99,99), QColor(37,37,37) };
							sequential_map[std::make_pair(Greys, Five)] = to_colours(coloursGreys5, coloursGreys5 + 5);
							...
							sequential_map[std::make_pair(Greys, Six)] = to_colours(coloursGreys6, coloursGreys6 + 6);
							...
							sequential_map[std::make_pair(Greys, Seven)] = to_colours(coloursGreys7, coloursGreys7 + 7);
							...
							sequential_map[std::make_pair(Greys, Eight)] = to_colours(coloursGreys8, coloursGreys8 + 8);
							...
							sequential_map[std::make_pair(Greys, Nine)] = to_colours(coloursGreys9, coloursGreys9 + 9);

							const QColor coloursYlGn3[3] = { QColor(247,252,185), QColor(173,221,142), QColor(49,163,84) };
							sequential_map[std::make_pair(YlGn, Three)] = to_colours(coloursYlGn3, coloursYlGn3 + 3);
							const QColor coloursYlGn4[4] = { QColor(255,255,204), QColor(194,230,153), QColor(120,198,121), QColor(35,132,67) };
							sequential_map[std::make_pair(YlGn, Four)] = to_colours(coloursYlGn4, coloursYlGn4 + 4);
							const QColor coloursYlGn5[5] = { QColor(255,255,204), QColor(194,230,153), QColor(120,198,121), QColor(49,163,84), QColor(0,104,55) };
							sequential_map[std::make_pair(YlGn, Five)] = to_colours(coloursYlGn5, coloursYlGn5 + 5);
							...
							sequential_map[std::make_pair(YlGn, Six)] = to_colours(coloursYlGn6, coloursYlGn6 + 6);
							...
							sequential_map[std::make_pair(YlGn, Seven)] = to_colours(coloursYlGn7, coloursYlGn7 + 7);
							...
							sequential_map[std::make_pair(YlGn, Eight)] = to_colours(coloursYlGn8, coloursYlGn8 + 8);
							...
							sequential_map[std::make_pair(YlGn, Nine)] = to_colours(coloursYlGn9, coloursYlGn9 + 9);

							const QColor coloursPurples3[3] = { QColor(239,237,245), QColor(188,189,220), QColor(117,107,177) };
							sequential_map[std::make_pair(Purples, Three)] = to_colours(coloursPurples3, coloursPurples3 + 3);
							const QColor coloursPurples4[4] = { QColor(242,240,247), QColor(203,201,226), QColor(158,154,200), QColor(106,81,163) };
							sequential_map[std::make_pair(Purples, Four)] = to_colours(coloursPurples4, coloursPurples4 + 4);
							...
							sequential_map[std::make_pair(Purples, Five)] = to_colours(coloursPurples5, coloursPurples5 + 5);
							...
							sequential_map[std::make_pair(Purples, Six)] = to_colours(coloursPurples6, coloursPurples6 + 6);
							...
							sequential_map[std::make_pair(Purples, Seven)] = to_colours(coloursPurples7, coloursPurples7 + 7);
							...
							sequential_map[std::make_pair(Purples, Eight)] = to_colours(coloursPurples8, coloursPurples8 + 8);
							...
							sequential_map[std::make_pair(Purples, Nine)] = to_colours(coloursPurples9, coloursPurples9 + 9);
				...
				namespace
				{
							...
							Classes classes)
					{
						...
						if (!diverging_map_initialised)
						{
							...
							const QColor coloursSpectral3[3] = { QColor(252,141,89), QColor(255,255,191), QColor(153,213,148) };
							diverging_map[std::make_pair(Spectral, Three)] = to_colours(coloursSpectral3, coloursSpectral3 + 3);
							const QColor coloursSpectral4[4] = { QColor(215,25,28), QColor(253,174,97), QColor(171,221,164), QColor(43,131,186) };
							diverging_map[std::make_pair(Spectral, Four)] = to_colours(coloursSpectral4, coloursSpectral4 + 4);
							...
							diverging_map[std::make_pair(Spectral, Five)] = to_colours(coloursSpectral5, coloursSpectral5 + 5);
							...
							diverging_map[std::make_pair(Spectral, Six)] = to_colours(coloursSpectral6, coloursSpectral6 + 6);
							...
							diverging_map[std::make_pair(Spectral, Seven)] = to_colours(coloursSpectral7, coloursSpectral7 + 7);
							...
							diverging_map[std::make_pair(Spectral, Eight)] = to_colours(coloursSpectral8, coloursSpectral8 + 8);
							...
							diverging_map[std::make_pair(Spectral, Nine)] = to_colours(coloursSpectral9, coloursSpectral9 + 9);
							...
							diverging_map[std::make_pair(Spectral, Ten)] = to_colours(coloursSpectral10, coloursSpectral10 + 10);
							...
							diverging_map[std::make_pair(Spectral, Eleven)] = to_colours(coloursSpectral11, coloursSpectral11 + 11);

							const QColor coloursRdYlBu3[3] = { QColor(252,141,89), QColor(255,255,191), QColor(145,191,219) };
							diverging_map[std::make_pair(RdYlBu, Three)] = to_colours(coloursRdYlBu3, coloursRdYlBu3 + 3);
							const QColor coloursRdYlBu4[4] = { QColor(215,25,28), QColor(253,174,97), QColor(171,217,233), QColor(44,123,182) };
							diverging_map[std::make_pair(RdYlBu, Four)] = to_colours(coloursRdYlBu4, coloursRdYlBu4 + 4);
							const QColor coloursRdYlBu5[5] = { QColor(215,25,28), QColor(253,174,97), QColor(255,255,191), QColor(171,217,233), QColor(44,123,182) };
							diverging_map[std::make_pair(RdYlBu, Five)] = to_colours(coloursRdYlBu5, coloursRdYlBu5 + 5);
							...
							diverging_map[std::make_pair(RdYlBu, Six)] = to_colours(coloursRdYlBu6, coloursRdYlBu6 + 6);
							...
							diverging_map[std::make_pair(RdYlBu, Seven)] = to_colours(coloursRdYlBu7, coloursRdYlBu7 + 7);
							...
							diverging_map[std::make_pair(RdYlBu, Eight)] = to_colours(coloursRdYlBu8, coloursRdYlBu8 + 8);
							...
							diverging_map[std::make_pair(RdYlBu, Nine)] = to_colours(coloursRdYlBu9, coloursRdYlBu9 + 9);
							...
							diverging_map[std::make_pair(RdYlBu, Ten)] = to_colours(coloursRdYlBu10, coloursRdYlBu10 + 10);
							...
							diverging_map[std::make_pair(RdYlBu, Eleven)] = to_colours(coloursRdYlBu11, coloursRdYlBu11 + 11);

							const QColor coloursRdYlGn3[3] = { QColor(252,141,89), QColor(255,255,191), QColor(145,207,96) };
							diverging_map[std::make_pair(RdYlGn, Three)] = to_colours(coloursRdYlGn3, coloursRdYlGn3 + 3);
							const QColor coloursRdYlGn4[4] = { QColor(215,25,28), QColor(253,174,97), QColor(166,217,106), QColor(26,150,65) };
							diverging_map[std::make_pair(RdYlGn, Four)] = to_colours(coloursRdYlGn4, coloursRdYlGn4 + 4);
							const QColor coloursRdYlGn5[5] = { QColor(215,25,28), QColor(253,174,97), QColor(255,255,191), QColor(166,217,106), QColor(26,150,65) };
							diverging_map[std::make_pair(RdYlGn, Five)] = to_colours(coloursRdYlGn5, coloursRdYlGn5 + 5);
							...
							diverging_map[std::make_pair(RdYlGn, Six)] = to_colours(coloursRdYlGn6, coloursRdYlGn6 + 6);
							...
							diverging_map[std::make_pair(RdYlGn, Seven)] = to_colours(coloursRdYlGn7, coloursRdYlGn7 + 7);
							...
							diverging_map[std::make_pair(RdYlGn, Eight)] = to_colours(coloursRdYlGn8, coloursRdYlGn8 + 8);
							...
							diverging_map[std::make_pair(RdYlGn, Nine)] = to_colours(coloursRdYlGn9, coloursRdYlGn9 + 9);
							...
							diverging_map[std::make_pair(RdYlGn, Ten)] = to_colours(coloursRdYlGn10, coloursRdYlGn10 + 10);
							...
							diverging_map[std::make_pair(RdYlGn, Eleven)] = to_colours(coloursRdYlGn11, coloursRdYlGn11 + 11);

							const QColor coloursPiYG3[3] = { QColor(233,163,201), QColor(247,247,247), QColor(161,215,106) };
							diverging_map[std::make_pair(PiYG, Three)] = to_colours(coloursPiYG3, coloursPiYG3 + 3);
							const QColor coloursPiYG4[4] = { QColor(208,28,139), QColor(241,182,218), QColor(184,225,134), QColor(77,172,38) };
							diverging_map[std::make_pair(PiYG, Four)] = to_colours(coloursPiYG4, coloursPiYG4 + 4);
							const QColor coloursPiYG5[5] = { QColor(208,28,139), QColor(241,182,218), QColor(247,247,247), QColor(184,225,134), QColor(77,172,38) };
							diverging_map[std::make_pair(PiYG, Five)] = to_colours(coloursPiYG5, coloursPiYG5 + 5);
							...
							diverging_map[std::make_pair(PiYG, Six)] = to_colours(coloursPiYG6, coloursPiYG6 + 6);
							...
							diverging_map[std::make_pair(PiYG, Seven)] = to_colours(coloursPiYG7, coloursPiYG7 + 7);
							...
							diverging_map[std::make_pair(PiYG, Eight)] = to_colours(coloursPiYG8, coloursPiYG8 + 8);
							...
							diverging_map[std::make_pair(PiYG, Nine)] = to_colours(coloursPiYG9, coloursPiYG9 + 9);
							...
							diverging_map[std::make_pair(PiYG, Ten)] = to_colours(coloursPiYG10, coloursPiYG10 + 10);
							...
							diverging_map[std::make_pair(PiYG, Eleven)] = to_colours(coloursPiYG11, coloursPiYG11 + 11);

							const QColor coloursPuOr3[3] = { QColor(241,163,64), QColor(247,247,247), QColor(153,142,195) };
							diverging_map[std::make_pair(PuOr, Three)] = to_colours(coloursPuOr3, coloursPuOr3 + 3);
							const QColor coloursPuOr4[4] = { QColor(230,97,1), QColor(253,184,99), QColor(178,171,210), QColor(94,60,153) };
							diverging_map[std::make_pair(PuOr, Four)] = to_colours(coloursPuOr4, coloursPuOr4 + 4);
							const QColor coloursPuOr5[5] = { QColor(230,97,1), QColor(253,184,99), QColor(247,247,247), QColor(178,171,210), QColor(94,60,153) };
							diverging_map[std::make_pair(PuOr, Five)] = to_colours(coloursPuOr5, coloursPuOr5 + 5);
							...
							diverging_map[std::make_pair(PuOr, Six)] = to_colours(coloursPuOr6, coloursPuOr6 + 6);
							...
							diverging_map[std::make_pair(PuOr, Seven)] = to_colours(coloursPuOr7, coloursPuOr7 + 7);
							...
							diverging_map[std::make_pair(PuOr, Eight)] = to_colours(coloursPuOr8, coloursPuOr8 + 8);
							...
							diverging_map[std::make_pair(PuOr, Nine)] = to_colours(coloursPuOr9, coloursPuOr9 + 9);
							...
							diverging_map[std::make_pair(PuOr, Ten)] = to_colours(coloursPuOr10, coloursPuOr10 + 10);
							...
							diverging_map[std::make_pair(PuOr, Eleven)] = to_colours(coloursPuOr11, coloursPuOr11 + 11);

							const QColor coloursBrBG3[3] = { QColor(216,179,101), QColor(245,245,245), QColor(90,180,172) };
							diverging_map[std::make_pair(BrBG, Three)] = to_colours(coloursBrBG3, coloursBrBG3 + 3);
							const QColor coloursBrBG4[4] = { QColor(166,97,26), QColor(223,194,125), QColor(128,205,193), QColor(1,133,113) };
							diverging_map[std::make_pair(BrBG, Four)] = to_colours(coloursBrBG4, coloursBrBG4 + 4);
							const QColor coloursBrBG5[5] = { QColor(166,97,26), QColor(223,194,125), QColor(245,245,245), QColor(128,205,193), QColor(1,133,113) };
							diverging_map[std::make_pair(BrBG, Five)] = to_colours(coloursBrBG5, coloursBrBG5 + 5);
							...
							diverging_map[std::make_pair(BrBG, Six)] = to_colours(coloursBrBG6, coloursBrBG6 + 6);
							...
							diverging_map[std::make_pair(BrBG, Seven)] = to_colours(coloursBrBG7, coloursBrBG7 + 7);
							...
							diverging_map[std::make_pair(BrBG, Eight)] = to_colours(coloursBrBG8, coloursBrBG8 + 8);
							...
							diverging_map[std::make_pair(BrBG, Nine)] = to_colours(coloursBrBG9, coloursBrBG9 + 9);
							...
							diverging_map[std::make_pair(BrBG, Ten)] = to_colours(coloursBrBG10, coloursBrBG10 + 10);
							...
							diverging_map[std::make_pair(BrBG, Eleven)] = to_colours(coloursBrBG11, coloursBrBG11 + 11);

							const QColor coloursPRGn3[3] = { QColor(175,141,195), QColor(247,247,247), QColor(127,191,123) };
							diverging_map[std::make_pair(PRGn, Three)] = to_colours(coloursPRGn3, coloursPRGn3 + 3);
							const QColor coloursPRGn4[4] = { QColor(123,50,148), QColor(194,165,207), QColor(166,219,160), QColor(0,136,55) };
							diverging_map[std::make_pair(PRGn, Four)] = to_colours(coloursPRGn4, coloursPRGn4 + 4);
							const QColor coloursPRGn5[5] = { QColor(123,50,148), QColor(194,165,207), QColor(247,247,247), QColor(166,219,160), QColor(0,136,55) };
							diverging_map[std::make_pair(PRGn, Five)] = to_colours(coloursPRGn5, coloursPRGn5 + 5);
							...
							diverging_map[std::make_pair(PRGn, Six)] = to_colours(coloursPRGn6, coloursPRGn6 + 6);
							...
							diverging_map[std::make_pair(PRGn, Seven)] = to_colours(coloursPRGn7, coloursPRGn7 + 7);
							...
							diverging_map[std::make_pair(PRGn, Eight)] = to_colours(coloursPRGn8, coloursPRGn8 + 8);
							...
							diverging_map[std::make_pair(PRGn, Nine)] = to_colours(coloursPRGn9, coloursPRGn9 + 9);
							...
							diverging_map[std::make_pair(PRGn, Ten)] = to_colours(coloursPRGn10, coloursPRGn10 + 10);
							...
							diverging_map[std::make_pair(PRGn, Eleven)] = to_colours(coloursPRGn11, coloursPRGn11 + 11);

							const QColor coloursRdBu3[3] = { QColor(239,138,98), QColor(247,247,247), QColor(103,169,207) };
							diverging_map[std::make_pair(RdBu, Three)] = to_colours(coloursRdBu3, coloursRdBu3 + 3);
							const QColor coloursRdBu4[4] = { QColor(202,0,32), QColor(244,165,130), QColor(146,197,222), QColor(5,113,176) };
							diverging_map[std::make_pair(RdBu, Four)] = to_colours(coloursRdBu4, coloursRdBu4 + 4);
							const QColor coloursRdBu5[5] = { QColor(202,0,32), QColor(244,165,130), QColor(247,247,247), QColor(146,197,222), QColor(5,113,176) };
							diverging_map[std::make_pair(RdBu, Five)] = to_colours(coloursRdBu5, coloursRdBu5 + 5);
							...
							diverging_map[std::make_pair(RdBu, Six)] = to_colours(coloursRdBu6, coloursRdBu6 + 6);
							...
							diverging_map[std::make_pair(RdBu, Seven)] = to_colours(coloursRdBu7, coloursRdBu7 + 7);
							...
							diverging_map[std::make_pair(RdBu, Eight)] = to_colours(coloursRdBu8, coloursRdBu8 + 8);
							...
							diverging_map[std::make_pair(RdBu, Nine)] = to_colours(coloursRdBu9, coloursRdBu9 + 9);
							...
							diverging_map[std::make_pair(RdBu, Ten)] = to_colours(coloursRdBu10, coloursRdBu10 + 10);
							...
							diverging_map[std::make_pair(RdBu, Eleven)] = to_colours(coloursRdBu11, coloursRdBu11 + 11);

							const QColor coloursRdGy3[3] = { QColor(239,138,98), QColor(255,255,255), QColor(153,153,153) };
							diverging_map[std::make_pair(RdGy, Three)] = to_colours(coloursRdGy3, coloursRdGy3 + 3);
							const QColor coloursRdGy4[4] = { QColor(202,0,32), QColor(244,165,130), QColor(186,186,186), QColor(64,64,64) };
							diverging_map[std::make_pair(RdGy, Four)] = to_colours(coloursRdGy4, coloursRdGy4 + 4);
							const QColor coloursRdGy5[5] = { QColor(202,0,32), QColor(244,165,130), QColor(255,255,255), QColor(186,186,186), QColor(64,64,64) };
							diverging_map[std::make_pair(RdGy, Five)] = to_colours(coloursRdGy5, coloursRdGy5 + 5);
							...
							diverging_map[std::make_pair(RdGy, Six)] = to_colours(coloursRdGy6, coloursRdGy6 + 6);
							...
							diverging_map[std::make_pair(RdGy, Seven)] = to_colours(coloursRdGy7, coloursRdGy7 + 7);
							...
							diverging_map[std::make_pair(RdGy, Eight)] = to_colours(coloursRdGy8, coloursRdGy8 + 8);
							...
							diverging_map[std::make_pair(RdGy, Nine)] = to_colours(coloursRdGy9, coloursRdGy9 + 9);
							...
							diverging_map[std::make_pair(RdGy, Ten)] = to_colours(coloursRdGy10, coloursRdGy10 + 10);
							...
							diverging_map[std::make_pair(RdGy, Eleven)] = to_colours(coloursRdGy11, coloursRdGy11 + 11);
		...
		const double &max_log_spacing)
{
	...
	const Colour zero_colour = colour_from_qcolor(QColor("#f7f7f7"));
	const Colour contraction_colours[num_blends + 1] =
	{
		zero_colour,
		colour_from_qcolor(QColor("#d1e5f0")),
		colour_from_qcolor(QColor("#92c5de")),
		colour_from_qcolor(QColor("#4393c3")),
		colour_from_qcolor(QColor("#2166ac")),
		colour_from_qcolor(QColor("#053061"))
	};
	const Colour extension_colours[num_blends + 1] =
	{
		zero_colour,
		colour_from_qcolor(QColor("#fddbc7")),
		colour_from_qcolor(QColor("#f4a582")),
		colour_from_qcolor(QColor("#d6604d")),
		colour_from_qcolor(QColor("#b2182b")),
		colour_from_qcolor(QColor("#67001f"))
	};
		...
		const double &max_log_spacing)
{
	...
	static const Colour zero_colour = colour_from_qcolor(QColor(Qt::white));
	static const Colour colours[] =
	{
		zero_colour,
		colour_from_qcolor(QColor(Qt::blue)),
		colour_from_qcolor(QColor(Qt::cyan)),
		colour_from_qcolor(QColor(Qt::yellow)),
		colour_from_qcolor(QColor(Qt::red)),
		colour_from_qcolor(QColor(Qt::magenta)),
		colour_from_qcolor(QColor(Qt::darkMagenta))
	};
