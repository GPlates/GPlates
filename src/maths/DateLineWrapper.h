...
namespace GPlatesMaths
{
	...
	public:
		...
		public:
			...
			LatLonPolygon() :
				d_exterior_points(new lat_lon_points_seq_type())
			{  }
			...
			{
				return *d_exterior_points;
			}

			lat_lon_points_seq_type &
			get_exterior_points()
			{
				return *d_exterior_points;
			}
		...
		private:
			...
			boost::shared_ptr<lat_lon_points_seq_type> d_exterior_points;
		};
