...
def get_overriding_and_subducting_plates(
    ...
    :rtype: 2-tuple of ReconstructionGeometry (or None if enforce_single_plates is False), or 3-tuple appending a str, or None
...
def get_overriding_plate(
    ...
    :rtype: ReconstructionGeometry (or None if enforce_single_plate is False), or 2-tuple appending a str, or None
