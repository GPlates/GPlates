...
namespace GPlatesFileIO
{
	...
	namespace MipmappedRasterFormat
	{
		 ...
		 */
		const unsigned int THRESHOLD_SIZE = 256;
		...
		/**
		 * Thrown when reading a mipmap file containing an unrecognised version number.
		 *
		 * This happens after reading the magic number so we're fairly sure it's a mipmap
		 * file that GPlates wrote.
		 *
		 * Most likely we're this is an old version of GPlates and we're reading a mipmap file
		 * generated by a newer version of GPlates.
		 */
