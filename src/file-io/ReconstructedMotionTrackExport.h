...
#ifndef GPLATES_FILEIO_RECONSTRUCTEDMOTIONTRACKEXPORT_H
#define GPLATES_FILEIO_RECONSTRUCTEDMOTIONTRACKEXPORT_H
...
{
	namespace ReconstructedMotionTrackExport
	{
		...
		//! Typedef for sequence of reconstructed motion_tracks.
		 ...
		 */
		ReconstructedMotionTrackExport::Format
		...
		/**
		 * Exports @a ReconstructedMotionTrack objects.
		 *
		 ...
		 */
		void
		export_reconstructed_motion_tracks(
...
#endif // GPLATES_FILEIO_RECONSTRUCTEDMOTIONTRACKEXPORT_H
