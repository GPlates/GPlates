...
GPlatesQtWidgets::MotionPathPropertiesWidget::MotionPathPropertiesWidget(
...
void
GPlatesQtWidgets::MotionPathPropertiesWidget::add_properties_to_feature(
...
void
GPlatesQtWidgets::MotionPathPropertiesWidget::add_geometry_properties_to_feature(
        GPlatesModel::FeatureHandle::weak_ref feature_handle)
{
...
void
GPlatesQtWidgets::MotionPathPropertiesWidget::update()
{
