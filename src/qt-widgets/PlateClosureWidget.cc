	...
	d_topology_geometry_opt_ptr(boost::none)
{
	...
	// Edit Topology button to load the feature_focus as topology
...
void
GPlatesQtWidgets::PlateClosureWidget::connect_to_focus_signals(bool state)
{
	if (state) 
	{
...
//
void
GPlatesQtWidgets::PlateClosureWidget::handle_reconstruction_time_change(
		double new_time)
{
...
//
void
GPlatesQtWidgets::PlateClosureWidget::set_focus(
		GPlatesModel::FeatureHandle::weak_ref feature_ref,
		GPlatesModel::ReconstructedFeatureGeometry::maybe_null_ptr_type associated_rfg)
{
	if (! d_is_active ) { return; }
qDebug() << "PlateClosureWidget::set_focus():";

	if ( ! associated_rfg) {
qDebug() << "PlateClosureWidget::set_focus(): no rfg";
	}
...
qDebug() << "PlateClosureWidget::set_focus(): END";
...
GPlatesQtWidgets::PlateClosureWidget::display_feature_focus_modified(
		...
		GPlatesModel::ReconstructedFeatureGeometry::maybe_null_ptr_type associated_rfg)
{
qDebug() << "PlateClosureWidget::display_feature_focus_modified:";
...
GPlatesQtWidgets::PlateClosureWidget::display_feature(
		...
		GPlatesModel::ReconstructedFeatureGeometry::maybe_null_ptr_type associated_rfg)
{
qDebug() << "PlateClosureWidget::display_feature:";
	...
	// Set widget states
	// NOTE: do not change button_new_topology
	button_edit_topology->setEnabled(false);
	label_type->setEnabled(false);
	lineedit_type->setEnabled(false);
	label_name->setEnabled(false);
	...
	if ( ! feature_ref.is_valid() ) 
	{
qDebug() << "PlateClosureWidget::display_feature: invalid ref";
...
qDebug() << "PlateClosureWidget::display_feature: END";
			return;
		}
...
int 
GPlatesQtWidgets::PlateClosureWidget::find_feature_in_topology(
		GPlatesModel::FeatureHandle::weak_ref feature_ref )
{
qDebug() << "PlateClosureWidget::find_feature_in_topology()";
...
qDebug() << "index = " << index << "; section_id = " << GPlatesUtils::make_qstring_from_icu_string( section_id.get() );
		...
		{
qDebug() << "MATCH MATHC MATCHA MTADSAMTQWA AMTWMAMCA MAMTMA MATMA CMATACH MATCH";
			return index;
		}
	}
...
qDebug() << "PlateClosureWidget::display_feature_topology() END";
}
...
qDebug() << "-------------------------------------------------";
	...
	if ( ! feature_ref.is_valid() ) {
qDebug() << "PlateClosureWidget::display_feature_on_boundary() invalid ref";
		return;
	} 
...
void
GPlatesQtWidgets::PlateClosureWidget::display_feature_off_boundary(
		GPlatesModel::FeatureHandle::weak_ref feature_ref,
		GPlatesModel::ReconstructedFeatureGeometry::maybe_null_ptr_type associated_rfg)
{
qDebug() << "-----------------------------------------------------";
qDebug() << "PlateClosureWidget::display_feature_off_boundary()";
qDebug() << "-----------------------------------------------------";
	// always double check your weak_refs!
	if ( ! feature_ref.is_valid() ) {
		return;
...
GPlatesQtWidgets::PlateClosureWidget::handle_new_topology()
{
	...
	GPlatesQtWidgets::PlateClosureWidget::display_feature_off_boundary(
		...
		d_feature_focus_ptr->associated_rfg() );
	...
	// allow apply to create new boundary property for topology
	button_apply->setEnabled(true);
}
...
GPlatesQtWidgets::PlateClosureWidget::handle_edit_topology()
{
	...
	// set the topology_feature ref 
	d_topology_feature_ref = d_feature_focus_ptr->focused_feature();

	//d_topology_feature_rfg = d_feature_focus_ptr->associated_rfg();
	// NOTE: this is not needed, since the rfg is computed from the topological sections
	// upon each call to update_geometry

#if 0
	// Just in case, re-disply the topology feature 
	GPlatesQtWidgets::PlateClosureWidget::display_feature_topology(
		d_feature_focus_ptr->focused_feature(),
		d_feature_focus_ptr->associated_rfg() );
#endif
...
{
qDebug() << "PlateClosureWidget::handle_use_coordinates_in_reverse";
...
qDebug() << "PlateClosureWidget::handle_use_coordinates_in_reverse() call d_feature_focus_ptr->unset_focus();";
	// NOTE: this will trigger a set_focus signal with NULL ref
	d_feature_focus_ptr->unset_focus();
	d_feature_focus_head_points.clear();
	d_feature_focus_tail_points.clear();

qDebug() << "PlateClosureWidget::handle_use_coordinates_in_reverse() call d_view_state_ptr->feature_table_model().clear()";
	// NOTE: the call to unset_focus does not clear the "Clicked" table, so do it here
	d_view_state_ptr->feature_table_model().clear();

qDebug() << "PlateClosureWidget::handle_use_coordinates_in_reverse() call update_geom";
...
qDebug() << "PlateClosureWidget::handle_use_coordinates_in_reverse() END";
qDebug() << "PlateClosureWidget::handle_use_coordinates_in_reverse() END";
qDebug() << "PlateClosureWidget::handle_use_coordinates_in_reverse() END";
qDebug() << "PlateClosureWidget::handle_use_coordinates_in_reverse() END";
qDebug() << "PlateClosureWidget::handle_use_coordinates_in_reverse() END";
...
void
GPlatesQtWidgets::PlateClosureWidget::handle_add_feature()
{
	// adjust the mode
	d_in_edit = true;
...
void
GPlatesQtWidgets::PlateClosureWidget::handle_insert_feature(int index)
{
qDebug() << "PlateClosureWidget::handle_insert_feature()";
qDebug() << "index = " << index;
...
qDebug() << "PlateClosureWidget::handle_insert_feature() call d_feature_focus_ptr->unset_focus();";

	// NOTE: this will trigger a set_focus signal with NULL ref
	d_feature_focus_ptr->unset_focus();
	d_feature_focus_head_points.clear();
	d_feature_focus_tail_points.clear();
qDebug() << "PlateClosureWidget::handle_insert_feature() call d_view_state_ptr->feature_table_model().clear()";
	// NOTE: the call to unset_focus does not clear the "Clicked" table, so do it here
	d_view_state_ptr->feature_table_model().clear();


qDebug() << "PlateClosureWidget::handle_insert_feature() call update_geom";
	// set flags for visit from update_geom()
	d_visit_to_check_type = false;
	d_visit_to_create_properties = true;
	update_geometry();
	...
	// allow apply to create new boundary property for topology
	button_apply->setEnabled(true);
qDebug() << "PlateClosureWidget::handle_insert_feature() END";
...
{
qDebug() << "PlateClosureWidget::handle_remove_feature()";
...
qDebug() << "PlateClosureWidget::handle_remove_feature() END";
}

void
GPlatesQtWidgets::PlateClosureWidget::handle_insert_after()
{
qDebug() << "PlateClosureWidget::handle_insert_after()";
...
{
qDebug() << "PlateClosureWidget::handle_insert_before()";
...
{
qDebug() << "PlateClosureWidget::handle_clear()";
...
{
qDebug() << "PlateClosureWidget::handle_apply()";
	...
	if ( ! d_topology_feature_ref.is_valid() )
	{
		...
		qDebug() << "PlateClosureWidget::handle_apply() END";
		return;
	}
...
{
qDebug() << "PlateClosureWidget::handle_cancel()";
...
qDebug() << "PlateClosureWidget::handle_cancel() END";
}
...
{ 
	...
	if (d_visit_to_check_type) {
#ifdef DEBUG1
qDebug() << "PlateClosureWidget::visit_point_on_sphere(): TYPE";
#endif
	...
	{
#ifdef DEBUG1
qDebug() << "PlateClosureWidget::visit_point_on_sphere(): END_POINTS";
#endif
...
#ifdef DEBUG1
qDebug() << "PlateClosureWidget::visit_point_on_sphere(): VERTS";
#endif
	// set the global flag for intersection processing 
	d_tmp_process_intersections = false;
...
#ifdef DEBUG1
qDebug() << "PlateClosureWidget::visit_point_on_sphere(): PROPS";
#endif
...
{  
	...
	if (d_visit_to_check_type) {
#ifdef DEBUG1
qDebug() << "PlateClosureWidget::visit_polyline_on_sphere(): TYPE";
#endif
	...
	{
#ifdef DEBUG1
qDebug() << "PlateClosureWidget::visit_polyline_on_sphere(): END_POINTS";
#endif
...
#ifdef DEBUG1
qDebug() << "PlateClosureWidget::visit_polyline_on_sphere(): VERTS";
#endif
...
#ifdef DEBUG1
qDebug() << "PlateClosureWidget::visit_polyline_on_sphere(): PROPS";
#endif
...
{
qDebug() << "PlateClosureWidget::draw_all_layers_clear()";
...
{
qDebug() << "PlateClosureWidget::draw_all_layers()";
	// draw all the layers
...
void
GPlatesQtWidgets::PlateClosureWidget::draw_topology_geometry()
{
#ifdef DEBUG1
qDebug() << "PlateClosureWidget::draw_topology_geometry()";
#endif
	d_topology_geometry_layer_ptr->clear_rendered_geometries();
	d_view_state_ptr->globe_canvas().update_canvas();
...
{
qDebug() << "PlateClosureWidget::draw_focused_geometry()";
	...
	{
qDebug() << "PlateClosureWidget::draw_focused_geometry() RFG okay";
	...
	{
qDebug() << "PlateClosureWidget::draw_focused_geometry() d_insert_feature_ref.is_valid()";
...
qDebug() << "PlateClosureWidget::draw_focused_geometry() END";
}
...
{
qDebug() << "PlateClosureWidget::draw_focused_geometry_end_points()";
...
{
qDebug() << "PlateClosureWidget::draw_segments()";
...
{
qDebug() << "PlateClosureWidget::draw_end_points()";
...
{
qDebug() << "PlateClosureWidget::draw_intersection_points()";
...
{
qDebug() << "PlateClosureWidget::draw_click_point()";
...
{
qDebug() << "PlateClosureWidget::draw_click_points()";
...
{
qDebug() << "PlateClosureWidget::update_geometry()";
...
///
void
GPlatesQtWidgets::PlateClosureWidget::fill_section_table_from_section_ids()
{
qDebug() << "PlateClosureWidget::fill_section_table_from_section_ids()";
	...
	// Clear the old data
qDebug() << "PlateClosureWidget::fill_section_table_from_section_ids() sections_table.clear";
	sections_table.clear();
...
{
qDebug() << "PlateClosureWidget::create_sections_from_sections_table()";
...
#ifdef DEBUG1
qDebug() << "PlateClosureWidget::process_intersections: "
...
#ifdef DEBUG1
qDebug() << "PlateClosureWidget::compute_intersection: " << "num_intersect = " << num_intersect;
#endif
...
#ifdef DEBUG1
qDebug() << "PlateClosureWidget::compute_intersection: INTERSECT_PREV: ";
#endif
...
#ifdef DEBUG1
qDebug() << "PlateClosureWidget::compute_intersection: INTERSECT_NEXT: ";
#endif
...
qDebug() << "PlateClosureWidget::compute_intersection:: HEAD: verts:";
for ( ; iter != end; ++iter) {
...
qDebug() << "PlateClosureWidget::compute_intersection:: TAIL: verts:";
for ( ; iter != end; ++iter) {
GPlatesMaths::LatLonPoint llp = GPlatesMaths::make_lat_lon_point(*iter);
qDebug() << "llp=" << llp.latitude() << "," << llp.longitude();
}
...
// PROXIMITY
		...
		{
			// FIXME : freak out!
			qDebug() << "PlateClosureWidget::compute_intersection: "
...
qDebug() << "PlateClosureWidget::append_boundary_value_to_feature() feature_ref = " 
...
qDebug() << "PlateClosureWidget::append_boundary_value_to_feature() END";
}


void
GPlatesQtWidgets::PlateClosureWidget::fill_section_vectors_from_feature_ref(
	GPlatesModel::FeatureHandle::weak_ref feature_ref)
{
qDebug() << "PlateClosureWidget::fill_sections_section_vectors_from_feature_ref()";
	if ( ! feature_ref.is_valid() ) 
	{
		return;
	}
