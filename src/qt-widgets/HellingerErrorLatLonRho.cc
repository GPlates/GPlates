/* $Id: HellingerErrorLatLonRho.cc 161 2012-01-30 15:42:19Z juraj.cirbus $ */
...
GPlatesQtWidgets::HellingerErrorLatLonRho::HellingerErrorLatLonRho(
...
void
GPlatesQtWidgets::HellingerErrorLatLonRho::continue_process()
{
d_process = true;
d_hellinger_model_ptr->set_error_lat_lon_rho(d_process);
}

void GPlatesQtWidgets::HellingerErrorLatLonRho::close_application()
{
d_process = false;
d_hellinger_model_ptr->set_error_lat_lon_rho(d_process);
}
...
void
GPlatesQtWidgets::HellingerErrorLatLonRho::update_buttons()
{
