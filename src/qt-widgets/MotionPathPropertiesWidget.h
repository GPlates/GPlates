...
#ifndef GPLATES_QTWIDGETS_MotionPathPROPERTIESWIDGET_H
#define GPLATES_QTWIDGETS_MotionPathPROPERTIESWIDGET_H

#include <QDebug>
#include <QWidget>

#include "AbstractCustomPropertiesWidget.h"
#include "MotionPathPropertiesWidgetUi.h"
...
namespace GPlatesQtWidgets
{
	...
	class MotionPathPropertiesWidget:
		public AbstractCustomPropertiesWidget,
		protected Ui_MotionPathPropertiesWidget
	{
		Q_OBJECT
	public:
		explicit
		MotionPathPropertiesWidget(
...
#endif // GPLATES_QTWIDGETS_MotionPathPROPERTIESWIDGET_H
