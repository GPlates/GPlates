...
#ifndef GPLATES_QTWIDGETS_EDIT_TOPOLOGY_WIDGET_H
#define GPLATES_QTWIDGETS_EDIT_TOPOLOGY_WIDGET_H
...
#include "EditTopologyWidgetUi.h"
...
namespace GPlatesQtWidgets
{
	...
	class EditTopologyWidget:
			...
			protected Ui_EditTopologyWidget
	{
		Q_OBJECT
	...
	public:
		...
		/**
		 * What kinds of geometry the EditTopologyWidget can be configured for.
		 */
		enum GeometryType
		{
			PLATEPOLYGON,
...
#endif  // GPLATES_QTWIDGETS_EDTT_TOPOLOGY_WIDGET_H
