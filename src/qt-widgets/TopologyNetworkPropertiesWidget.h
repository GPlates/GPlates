...
#ifndef GPLATES_QTWIDGETS_TOPOLOGYNETWORKPROPERTIESWIDGET_H
#define GPLATES_QTWIDGETS_TOPOLOGYNETWORKPROPERTIESWIDGET_H

#include <QDebug>
#include <QWidget>

#include "AbstractCustomPropertiesWidget.h"
#include "TopologyNetworkPropertiesWidgetUi.h"
...
{
	class TopologyNetworkPropertiesWidget:
		public AbstractCustomPropertiesWidget,
		protected Ui_TopologyNetworkPropertiesWidget
	{
		Q_OBJECT
	public:
		explicit
		TopologyNetworkPropertiesWidget(
			GPlatesAppLogic::ApplicationState *application_state_ptr,
			QWidget *parent_ = NULL);
			
		~TopologyNetworkPropertiesWidget()
		{
			qDebug() << "Deleting TopologyNetworkPropertiesWidget";
		}	
...
#endif // GPLATES_QTWIDGETS_TOPOLOGYNETWORKPROPERTIESWIDGET_H
