...
#ifndef GPLATES_MODEL_RECONSTRUCTIONGRAPH_H
...
namespace GPlatesModel
{
	...
	public:
		 ...
		 */
		typedef std::multimap<integer_plate_id_type, edge_ref_type> edge_refs_by_plate_id_map_type;
...
namespace std
{
	...
	inline
	void
	swap<GPlatesModel::ReconstructionGraph>(
			GPlatesModel::ReconstructionGraph &rg1,
			GPlatesModel::ReconstructionGraph &rg2)
	{
		rg1.swap(rg2);
	}
}

#endif  // GPLATES_MODEL_RECONSTRUCTIONGRAPH_H
