...
#ifndef GPLATES_MODEL_TEMPLATETYPEPARAMETERTYPE_H
#define GPLATES_MODEL_TEMPLATETYPEPARAMETERTYPE_H
...
namespace GPlatesModel {
	...
	public:
		...
		TemplateTypeParameterType(
			...
			d_ss_iter(StringSetSingletons::template_type_parameter_type_instance().insert(type))
		{ }
	...
	inline
	bool
	GPlatesModel::TemplateTypeParameterType::is_loaded(
			const UnicodeString &s) {
...
#endif  // GPLATES_MODEL_TEMPLATETYPEPARAMETERTYPE_H
