...
export_topological_model()
{
	...
	bp::class_<GPlatesAppLogic::TopologyPointLocation>(
		...
		.def("located_in_resolved_network_deforming_region",
				...
				"  :rtype: ResolvedTopologicalNetwork, or 2-tuple (ResolvedTopologicalNetwork, NetworkTriangulation.Triangle) "
		...
		.def("located_in_resolved_network_rigid_block",
				...
				"  :rtype: 2-tuple (ResolvedTopologicalNetwork, ReconstructedFeatureGeometry),  or None\n"
				"\n"
	...
	bp::class_<
		...
		.def("__init__",
			...
			"  :type topological_features: FeatureCollection, or string/os.PathLike, or Feature, "
