...
export_feature()
{
	...
	bp::class_<
		...
		.def("add",
				...
				"  :rtype: Property, or list of Property depending on whether property_value "
		...
		.def("set_geometry",
				...
				"  :rtype: Property or list of Property depending on whether geometry "
				"is a GeometryOnSphere or sequence of GeometryOnSphere (or 2-tuple of Property "
				"or list of 2-tuple of Property if geometry is a coverage or list of coverage - see below)\n"
				"  :raises: InformationModelError if *verify_information_model* is *VerifyInformationModel.yes* "
		...
		.def("set_topological_geometry",
				...
				"  :rtype: Property, or list of Property depending on whether topological_geometry "
