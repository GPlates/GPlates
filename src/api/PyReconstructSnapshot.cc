...
export_reconstruct_snapshot()
{
	...
	bp::class_<
		...
		.def("__init__",
			...
			"  :type reconstructable_features: FeatureCollection, or string/os.PathLike, or Feature, "
		...
		.def("get_point_velocities",
				...
				"  :rtype: list of Vector3D, or 2-tuple (list of Vector3D, list of ReconstructedFeatureGeometry) if "
