...
export_polyline_on_sphere()
{
	...
	bp::class_<
			...
			boost::noncopyable>(
					...
					"=========================== ==========================================================\n"
					"\n"
					".. note:: Since a *PolylineOnSphere* is **immutable** it contains no operations or "
					"methods that modify its state (such as adding or removing points). This is similar "
					"to other immutable types in python such as ``str``.\n"
					"\n"
...
export_polygon_on_sphere()
{
	...
	bp::scope polygon_on_sphere_class = bp::class_<
			...
			boost::noncopyable>(
					...
					"=========================== ==========================================================\n"
					"\n"
					".. note:: Since a *PolygonOnSphere* is **immutable** it contains no operations or "
					"methods that modify its state (such as adding or removing points). This is similar "
					"to other immutable types in python such as ``str``.\n"
					"\n"
