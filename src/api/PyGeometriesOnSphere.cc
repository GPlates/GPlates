...
export_geometry_on_sphere()
{
	...
	bp::class_<
		...
		.def("distance",
				...
				"  :type geometry2: GeometryOnSphere\n"
				...
				"  :rtype: float, or tuple (float, PointOnSphere, PointOnSphere) if "
				"return_closest_positions is True, or tuple (float, int, int) if return_closest_indices "
				"is True, or tuple (float, PointOnSphere, PointOnSphere, int, int) "
...
export_polyline_on_sphere()
{
	...
	bp::class_<
		...
		.def("to_uniform_points",
				...
				"  :rtype: list of PointOnSphere, or tuple (list of PointOnSphere, list of tuple (int, float)) if return_segment_informations is True\n"
...
export_polygon_on_sphere()
{
	...
	bp::class_<
		...
		.def("__init__",
				...
				"  :type exterior_ring: any sequence of PointOnSphere or LatLonPoint or "
				"tuple (float,float,float) or tuple (float,float).\n"
