...
#ifndef GPLATES_UTIL_CALLSTACKTRACKER_H
#define GPLATES_UTIL_CALLSTACKTRACKER_H
 ...
 */
#define CALL_STACK_MAGIC2(x) GPlatesUtil::CallStackTracker call_stack_tracker##x(__FILE__, __LINE__);
 ...
 *
 * This is a convenience macro to simplify the use of class GPlatesUtil::CallStackTracker.
 *
...
#endif  // GPLATES_UTIL_CALLSTACKTRACKER_H
