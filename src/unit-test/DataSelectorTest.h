 ...
 */
#ifndef GPLATES_UNIT_TEST_DATASELECTOR_TEST_H
#define GPLATES_UNIT_TEST_DATASELECTOR_TEST_H
...
namespace GPlatesUnitTest{
	...
	protected:
		...
		read_files(
				const QStringList &filenames /*In*/);
		
		GPlatesModel::ModelInterface d_model;

		std::vector<GPlatesFileIO::File::Reference> d_files;
	private:
		
	};

	
	class DataSelectorTestSuite : 
...
#endif //GPLATES_UNIT_TEST_DATASELECTOR_TEST_H 
