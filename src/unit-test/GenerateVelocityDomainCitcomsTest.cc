...
namespace
{
	class GenerateVelocityDomainCitcomsTest : public ::testing::Test
	{
	protected:
...
TEST_F(GenerateVelocityDomainCitcomsTest, citcoms_meshes)
{
	const int resolutions[] = { 9, 17, 33, 65 };
	for (int res : resolutions)
	{
		SCOPED_TRACE(testing::Message() << "resolution " << res);
