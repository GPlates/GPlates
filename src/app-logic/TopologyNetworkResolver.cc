...
void
GPlatesAppLogic::TopologyNetworkResolver::validate_topological_section_intersections()
{
...
void
GPlatesAppLogic::TopologyNetworkResolver::validate_topological_section_intersection(
...
void
GPlatesAppLogic::TopologyNetworkResolver::process_topological_section_intersections()
{
	// Iterate over our internal sequence of sections that we built up by
	// visiting the topological sections of a topological polygon.
	const std::size_t num_sections = d_resolved_network.d_sections.size();
...
void
GPlatesAppLogic::TopologyNetworkResolver::process_topological_section_intersection(
		const std::size_t current_section_index,
...
void
GPlatesAppLogic::TopologyNetworkResolver::assign_boundary_segment(
...
GPlatesAppLogic::TopologyNetworkResolver::create_resolved_topology_network()
{
	...
	// the user has created a network that includes a series individual points ( not a multi point )
...
qDebug() << "geom_type_finder: polygon:" << geometry_type_finder.num_polygon_geometries_found();
	...
	//
	// Now add all the group_of_related_points ; do contrain begin and end
	//
