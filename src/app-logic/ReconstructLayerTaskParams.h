...
#ifndef GPLATES_APP_LOGIC_RECONSTRUCTLAYERTASKPARAMS_H
#define GPLATES_APP_LOGIC_RECONSTRUCTLAYERTASKPARAMS_H
...
{
	/**
	 * ReconstructLayerTaskParams is used to store additional parameters and
	 * configuration options needed by the @a ReconstructLayerTask.
	 */
	class ReconstructLayerTaskParams :
...
#endif // GPLATES_APP_LOGIC_RECONSTRUCTLAYERTASKPARAMS_H
