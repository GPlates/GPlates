...
namespace GPlatesAppLogic
{
	...
	typedef GPlatesGlobal::PointerTraits<TopologyGeometryResolverLayerProxy>::non_null_ptr_type topology_boundary_resolver_layer_proxy_non_null_ptr_type;
	typedef GPlatesGlobal::PointerTraits<const TopologyGeometryResolverLayerProxy>::non_null_ptr_type topology_boundary_resolver_layer_proxy_non_null_ptr_to_const_type;
