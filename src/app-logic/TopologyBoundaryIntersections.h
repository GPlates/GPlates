...
#ifndef GPLATES_APP_LOGIC_TOPOLOGYBOUNDARYINTERSECTIONS_H
#define GPLATES_APP_LOGIC_TOPOLOGYBOUNDARYINTERSECTIONS_H
...
namespace GPlatesAppLogic
{
	 ...
	 * neighbouring sections to assist with determining the boundary partitioned segment.
	 *
	 ...
	 * is the boundary segment used for the plate polygon.
	 */
	class TopologicalBoundaryIntersections
	{
	public:
		/**
		 * We initialise with the full section geometry.
		 */
		TopologicalBoundaryIntersections(
		 ...
		 *
		 * This is a special case because under these conditions a topology plate polygon
		 * can be formed.
		 *
		...
		/**
		 * Returns the segment that will contribute to the boundary of the plate polygon.
		 *
		...
		get_unreversed_boundary_segment(
				bool reverse_hint) const;
	...
	private:
		...
		/**
		 * The segment that will contribute to the topological plate polygon boundary.
		 *
		...
		/**
		 * Determines and sets the boundary segment but requires two intersections
...
#endif // GPLATES_APP_LOGIC_TOPOLOGYBOUNDARYINTERSECTIONS_H
