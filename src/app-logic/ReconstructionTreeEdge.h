...
#ifndef GPLATES_APP_LOGIC_RECONSTRUCTIONTREEEDGE_H
#define GPLATES_APP_LOGIC_RECONSTRUCTIONTREEEDGE_H
...
namespace GPlatesAppLogic
{
	...
	public:
		/**
		 * A convenience typedef for a non-null intrusive pointer to a @a ReconstructionTreeEdge.
		 */
		...
		bool
		finite_rotation_was_interpolated() const
		{
			return d_finite_rotation_was_interpolated;
		}
...
#endif  // GPLATES_APP_LOGIC_RECONSTRUCTIONTREEEDGE_H
