...
void
GPlatesAppLogic::ReconstructedMotionTrack::accept_visitor(
...
void
GPlatesAppLogic::ReconstructedMotionTrack::accept_weak_observer_visitor(
		GPlatesModel::WeakObserverVisitor<GPlatesModel::FeatureHandle> &visitor)
{
	visitor.visit_reconstructed_motion_track(*this);
}

const GPlatesModel::FeatureHandle::weak_ref
GPlatesAppLogic::ReconstructedMotionTrack::get_feature_ref() const
{
	if (is_valid()) {
