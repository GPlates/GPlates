...
GPlatesAppLogic::TotalReconstructionSequenceRotationInserter::TotalReconstructionSequenceRotationInserter(
...
bool
GPlatesAppLogic::TotalReconstructionSequenceRotationInserter::initialise_pre_feature_properties(
...
void
GPlatesAppLogic::TotalReconstructionSequenceRotationInserter::visit_gpml_finite_rotation(
...
void
GPlatesAppLogic::TotalReconstructionSequenceRotationInserter::visit_gpml_finite_rotation_slerp(
...
void
GPlatesAppLogic::TotalReconstructionSequenceRotationInserter::visit_gpml_irregular_sampling(
...
void
GPlatesAppLogic::TotalReconstructionSequenceRotationInserter::update_finite_rotation(
		GPlatesPropertyValues::GpmlFiniteRotation &gpml_finite_rotation)
{
...
void
GPlatesAppLogic::TotalReconstructionSequenceRotationInserter::update_pole_metadata(
		GPlatesPropertyValues::GpmlFiniteRotation &gpml_finite_rotation)
{
...
void
GPlatesAppLogic::TotalReconstructionSequenceRotationInserter::set_pole_metadata(
		GPlatesPropertyValues::GpmlFiniteRotation &gpml_finite_rotation)
{
}
