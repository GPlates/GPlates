		...
		const LayerProxy::non_null_ptr_type &layer_proxy)
{
	...
	else if (input_channel_name == TOPOLOGICAL_BOUNDARY_SECTION_FEATURES_CHANNEL_NAME)
	{
		...
		{
			d_topology_boundary_resolver_layer_proxy->set_current_reconstruct_layer_proxy(
				...
				const LayerProxy::non_null_ptr_type &layer_proxy)
{
	...
	else if (input_channel_name == TOPOLOGICAL_BOUNDARY_SECTION_FEATURES_CHANNEL_NAME)
	{
		...
		if (reconstruct_layer_proxy)
		{
			...
			d_topology_boundary_resolver_layer_proxy->set_current_reconstruct_layer_proxy(boost::none);
		}
	}
}
