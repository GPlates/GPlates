...
#ifndef GPLATES_CANVASTOOLS_GLOBEINSERTVERTEX_H
#define GPLATES_CANVASTOOLS_GLOBEINSERTVERTEX_H
...
namespace GPlatesCanvasTools
{
	...
	public:
		 ...
		 */
		typedef GPlatesUtils::non_null_intrusive_ptr<GlobeInsertVertex,
		...
		/**
		 * Create a GlobeInsertVertex instance.
		 */
		static
		...
		{
			return GlobeInsertVertex::non_null_ptr_type(
					new GlobeInsertVertex(
...
#endif // GPLATES_CANVASTOOLS_GLOBEINSERTVERTEX_H
