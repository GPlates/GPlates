...
GPlatesCanvasTools::MapInsertVertex::MapInsertVertex(
...
void
GPlatesCanvasTools::MapInsertVertex::handle_activation()
{
...
void
GPlatesCanvasTools::MapInsertVertex::handle_deactivation()
{
...
void
GPlatesCanvasTools::MapInsertVertex::handle_left_click(
...
void
GPlatesCanvasTools::MapInsertVertex::handle_left_drag(
...
void
GPlatesCanvasTools::MapInsertVertex::handle_move_without_drag(
			const QPointF &current_point_on_scene,
			bool is_on_surface,
			const QPointF &translation)
{
