...
#ifndef GPLATES_CANVASTOOLS_GLOBEMOVEVERTEX_H
#define GPLATES_CANVASTOOLS_GLOBEMOVEVERTEX_H
...
namespace GPlatesCanvasTools
{
	 ...
	 */
	class GlobeMoveVertex:
			public GPlatesGui::GlobeCanvasTool
	{
	public:
		/**
		 * A convenience typedef for GPlatesUtils::non_null_intrusive_ptr<GlobeMoveVertex,
		 * GPlatesUtils::NullIntrusivePointerHandler>.
		 */
		typedef GPlatesUtils::non_null_intrusive_ptr<GlobeMoveVertex,
		...
		/**
		 * Create a GlobeMoveVertex instance.
		 */
		static
		...
		{
			return GlobeMoveVertex::non_null_ptr_type(
					new GlobeMoveVertex(
