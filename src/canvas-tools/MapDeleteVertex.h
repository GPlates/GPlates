...
#ifndef GPLATES_CANVASTOOLS_MAPDELETEVERTEX_H
#define GPLATES_CANVASTOOLS_MAPDELETEVERTEX_H
...
namespace GPlatesCanvasTools
{
	 ...
	 */
	class MapDeleteVertex:
			public GPlatesGui::MapCanvasTool
	{
	public:
		/**
		 * A convenience typedef for GPlatesUtils::non_null_intrusive_ptr<MapDeleteVertex,
		 * GPlatesUtils::NullIntrusivePointerHandler>.
		 */
		typedef GPlatesUtils::non_null_intrusive_ptr<MapDeleteVertex,
		...
		/**
		 * Create a MapDeleteVertex instance.
		 */
		static
		...
		{
			return MapDeleteVertex::non_null_ptr_type(
					new MapDeleteVertex(
...
#endif // GPLATES_CANVASTOOLS_MAPDELETEVERTEX_H
