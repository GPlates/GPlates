...
#ifndef GPLATES_CANVASTOOLS_GLOBEDIGITISEGEOMETRY_H
#define GPLATES_CANVASTOOLS_GLOBEDIGITISEGEOMETRY_H
...
namespace GPlatesCanvasTools
{
	 ...
	 */
	class GlobeDigitiseGeometry:
			public GPlatesGui::GlobeCanvasTool
	{
	public:
		/**
		 * A convenience typedef for GPlatesUtils::non_null_intrusive_ptr<GlobeDigitiseGeometry,
		 * GPlatesUtils::NullIntrusivePointerHandler>.
		 */
		typedef GPlatesUtils::non_null_intrusive_ptr<GlobeDigitiseGeometry,
				GPlatesUtils::NullIntrusivePointerHandler> non_null_ptr_type;

		virtual
		~GlobeDigitiseGeometry();

		/**
		 * Create a GlobeDigitiseGeometry instance.
		 *
	...
	private:
		...
		*/
		...
		/**
		 * This is the type of geometry this particular GlobeDigitiseGeometry tool
		 * should default to.
		 */
...
#endif  // GPLATES_CANVASTOOLS_GLOBEDIGITISEGEOMETRY_H
