...
#ifndef GPLATES_FEATUREVISITORS_PLATEPOLYGON_RESOLVER_H
#define GPLATES_FEATUREVISITORS_PLATEPOLYGON_RESOLVER_H
...
{
	class PlatepolygonResolver: public GPlatesModel::FeatureVisitor
	{
	public:
		...
		* geologic component of a Platepolygon's boundary.
		*
		* Platepolygon maintains a list of BoundaryFeature nodes.
		*
	...
	private:
		...
		*/
		...
		int d_num_features;
		int d_num_platepolygons;
	};

}

#endif  // GPLATES_FEATUREVISITORS_PLATEPOLYGON_RESOLVER_H
