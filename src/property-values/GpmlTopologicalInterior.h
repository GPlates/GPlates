...
#ifndef GPLATES_PROPERTYVALUES_GPMLTOPOLOGICALINTERIOR_H
#define GPLATES_PROPERTYVALUES_GPMLTOPOLOGICALINTERIOR_H
...
namespace GPlatesPropertyValues
{
	...
	public:
		 ...
		 * GPlatesUtils::non_null_intrusive_ptr<GpmlTopologicalInterior>.
		 */
		typedef GPlatesUtils::non_null_intrusive_ptr<GpmlTopologicalInterior> non_null_ptr_type;

		/**
		 * A convenience typedef for
		 * GPlatesUtils::non_null_intrusive_ptr<const GpmlTopologicalInterior>.
		 */
		typedef GPlatesUtils::non_null_intrusive_ptr<const GpmlTopologicalInterior> non_null_ptr_to_const_type;

		virtual
		~GpmlTopologicalInterior()
		{  }
			...
			const GpmlTopologicalSection::non_null_ptr_type &first_section)
		{
			non_null_ptr_type ptr(
					new GpmlTopologicalInterior( first_section ));
			return ptr;
		}
		...
		{
			non_null_ptr_type ptr(
					new GpmlTopologicalInterior( sections_ ));
			return ptr;
		}

		const GpmlTopologicalInterior::non_null_ptr_type
		clone() const
		{
			GpmlTopologicalInterior::non_null_ptr_type dup(
					new GpmlTopologicalInterior(*this));
			return dup;
		}
		...
		{
			visitor.visit_gpml_topological_interior(*this);
		}
	...
	protected:
		...
		GpmlTopologicalInterior(
				const GpmlTopologicalInterior &other) :
	...
	private:
		...
		GpmlTopologicalInterior &
		operator=(const GpmlTopologicalInterior &);

	};

}

#endif  // GPLATES_PROPERTYVALUES_GPMLTOPOLOGICALINTERIOR_H
