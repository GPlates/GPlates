...
bool
GPlatesPropertyValues::GeoTimeInstant::is_distant_past() const {
...
bool
GPlatesPropertyValues::GeoTimeInstant::is_distant_future() const {
...
bool
GPlatesPropertyValues::GeoTimeInstant::is_real() const {
